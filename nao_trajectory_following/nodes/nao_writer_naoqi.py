...
from nao_writing_msgs import MultiPaths
import rospy
import tf
...
def on_traj(traj_lst):
    ...
    if(hasFallen == False): #no harm in executing trajectory
        ...
        rospy.sleep(traj_lst.header.stamp-rospy.Time.now())#+rospy.Duration(timeToStartPosition));
